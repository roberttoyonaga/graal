...
public class DefaultIBADecoderProviderImpl implements IBADecoderProvider {
    @Override
...
final class DefaultIBADecoderFeature implements InternalFeature {
    ...
    public void afterRegistration(AfterRegistrationAccess access) {
        ImageSingletons.add(IBADecoderProvider.class, new DefaultIBADecoderProviderImpl());
    }
}
