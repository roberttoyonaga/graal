...
class PreInitTable extends AbstractUninterruptibleHashtable {
    ...
    protected UninterruptibleEntry copyToHeap(UninterruptibleEntry valueOnStack) {
        org.graalvm.word.UnsignedWord size = SizeOf.unsigned(UninterruptibleEntry.class);
    ...
    protected void free(UninterruptibleEntry entry) {
        ...
        NativeMemoryTracking.deaccountMallocCategory(SizeOf.unsigned(UninterruptibleEntry.class).rawValue(), NmtFlag.mtNMT.ordinal());
    }
