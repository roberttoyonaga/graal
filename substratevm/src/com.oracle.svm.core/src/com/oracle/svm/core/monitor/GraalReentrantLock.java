 ...
 * @author Doug Lea
 */
public class GraalReentrantLock implements Lock, java.io.Serializable {
...
//		@ReservedStackAccess
		...
		public GraalAbstractQueuedSynchronizer.ConditionObject graalConditionObject;

		public GraalAbstractQueuedSynchronizer.ConditionObject getGraalConditionObject() {
	 ...
	 */
	public GraalReentrantLock(boolean fair) {
...
//		if (!(condition instanceof GraalAbstractQueuedSynchronizer.ConditionObject))
//			throw new IllegalArgumentException("not owner");
//		return sync.hasWaiters((GraalAbstractQueuedSynchronizer.ConditionObject)condition);
//	}
...
//		if (!(condition instanceof GraalAbstractQueuedSynchronizer.ConditionObject))
//			throw new IllegalArgumentException("not owner");
//		return sync.getWaitQueueLength((GraalAbstractQueuedSynchronizer.ConditionObject)condition);
//	}
...
//		if (!(condition instanceof GraalAbstractQueuedSynchronizer.ConditionObject))
//			throw new IllegalArgumentException("not owner");
//		return sync.getWaitingThreads((GraalAbstractQueuedSynchronizer.ConditionObject)condition);
//	}
	...
	public GraalAbstractQueuedSynchronizer.ConditionObject getCondition() {
		return sync.getGraalConditionObject();
	}
	public void setCondition(GraalAbstractQueuedSynchronizer.ConditionObject newCondition) {
