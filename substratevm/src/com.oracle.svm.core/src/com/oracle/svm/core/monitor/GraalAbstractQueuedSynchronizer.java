 ...
 * @author Doug Lea
 */
public abstract class GraalAbstractQueuedSynchronizer
	 ...
	 */
	protected GraalAbstractQueuedSynchronizer() { }
	...
	public class ConditionObject implements Condition, java.io.Serializable {
		 ...
		 * @return {@code true} if owned
		 */
		final boolean isOwnedBy(GraalAbstractQueuedSynchronizer sync) {
			return sync == GraalAbstractQueuedSynchronizer.this;
		}
	...
	private static final long STATE
			= U.objectFieldOffset(GraalAbstractQueuedSynchronizer.class, "state");
